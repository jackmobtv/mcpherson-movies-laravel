                    ...
                    <div className=" border rounded-3 p-3 w-100">
                        <div className="list-group list-group-light list-group-borderless">
                            <a className={"list-group-item" + (pageTitle === "Favorites" ? " active" : "")}
                               href={appURL + "/favorites"}><i className="bi bi-star-fill me-2"></i>Favorites</a>
                            <a className={"list-group-item" + (pageTitle === "Ratings" ? " active" : "")}
                               href={appURL + "/ratings"}><i className="bi bi-film me-2"></i>Ratings</a>
                            <a className={"list-group-item" + (pageTitle === "Edit Profile" ? " active" : "")}
                               href={appURL + "/edit-profile"}><i className="bi bi-person-gear me-2"></i>Edit Profile</a>
                            <a className={"list-group-item" + (pageTitle === "Delete Account" ? " active" : "")}
                               href={appURL + "/delete-account"}><i className="bi bi-trash me-2"></i>Delete Account</a>
                        </div>
                    </div>
                </div>
            </div>
